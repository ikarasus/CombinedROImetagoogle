...
(function () {
  ...
  function calc() {
    ...
    const gRoas    = gbud > 0 ? gRevenue / gbud : 0;
    ...
    const mRoas    = mbud > 0 ? mRevenue / mbud : 0;
    ...
    const combinedRoas = totalBudget > 0 ? totalRevenue / totalBudget : 0;
    ...
    setText('g-roas',   froas(gRoas));
    setText('g-roas-hd', froas(gRoas));
    ...
    setText('m-roas',   froas(mRoas));
    setText('m-roas-hd', froas(mRoas));
    ...
    setText('c-roas', froas(combinedRoas));
  ...
  function readCurrentValues() {
    return {
      ...
      gRoasHd:    txt(document.getElementById('g-roas-hd')),
      ...
      mRoasHd:    txt(document.getElementById('m-roas-hd')),
      ...
      cRoas:      txt(document.getElementById('c-roas')),
      gRoas:      txt(document.getElementById('g-roas')),
      mRoas:      txt(document.getElementById('m-roas'))
    };
  }
  ...
  function buildPDF() {
    ...
    var summaries = [
      ...
      { label: 'COMBINED ROAS', val: d.cRoas, accent: false, roas: true }
    ];
    ...
    summaries.forEach(function (m, i) {
      ...
      doc.setFont('helvetica', 'normal');
      doc.setFontSize(6.5);
      doc.setTextColor(m.accent ? 180 : (m.roas ? 100 : 107), m.accent ? 210 : (m.roas ? 80 : 114), m.accent ? 255 : (m.roas ? 200 : 128));
      doc.text(m.label, bx + boxW / 2, y + 6.5, { align: 'center' });

      doc.setFont('helvetica', 'bold');
      doc.setFontSize(m.accent ? 14 : 10);
      doc.setTextColor(m.accent ? 255 : (m.roas ? 83 : 17), m.accent ? 255 : (m.roas ? 58 : 24), m.accent ? 255 : (m.roas ? 183 : 39));
